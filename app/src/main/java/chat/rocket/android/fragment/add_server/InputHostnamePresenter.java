...
public class InputHostnamePresenter extends BasePresenter<InputHostnameContract.View> implements InputHostnameContract.Presenter {
  ...
  public void connectToEnforced(final String hostname) {
    OkHttpHelper.INSTANCE.getClientForUploadFile(new OkHttpHelper.GetHttpClientListener() {
      @Override
      public void onHttpClientRetrieved(@Nullable OkHttpClient httpClient) {
        final ServerPolicyApi serverPolicyApi = new DefaultServerPolicyApi(httpClient, hostname);
